...
namespace ExcelApp
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            using( var conn = new MySqlConnection(configuration["ConnectionStrings:DBConnection"]))
            {
            ...
            FileInfo templateFile = new FileInfo(configuration["Settings:TemplateLocation"]);
